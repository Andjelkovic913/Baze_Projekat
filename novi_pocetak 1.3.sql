...
--
-- Host: localhost
-- Generation Time: May 23, 2025 at 10:10 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_kreiraj_psihoterapeuta` (IN `p_ime` VARCHAR(50), IN `p_prezime` VARCHAR(50), IN `p_email` VARCHAR(100), IN `p_telefon` VARCHAR(30), IN `p_jmbg` CHAR(13), IN `p_lozinka` VARCHAR(60), IN `p_datum_rodjenja` DATE, IN `p_prebivaliste` VARCHAR(100), IN `p_stepen_id` INT, IN `p_fakultet_id` INT, IN `p_centar_id` INT, IN `p_status_id` INT, IN `p_is_psiholog` TINYINT(1), IN `p_is_supervizor` TINYINT(1))   BEGIN
...
--
ALTER TABLE `psihoterapeut`
  MODIFY `psihoterapeut_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
