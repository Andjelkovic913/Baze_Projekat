...
INSERT INTO `psihoterapeut` (`psihoterapeut_id`, `ime`, `prezime`, `JMBG`, `datum_rodjenja`, `prebivaliste`, `telefon`, `email`, `stepen_id`, `fakultet_id`, `centar_id`, `status_id`, `is_psiholog`, `is_supervizor`) VALUES
(1, 'Jovana', 'Matić', '8601055710023', '1986-01-05', 'Beograd', '0653214321', 'jmatic@gmail.com', 3, 4, 1, 1, 1, 1),
(2, 'Miloš', 'Vuković', '8307225711024', '1983-07-22', 'Novi Sad', '0643314331', 'mvukovic@gmail.com', 3, 5, 2, 1, 1, 1),
(3, 'Katarina', 'Bogdanović', '7903315712025', '1979-03-31', 'Beograd', '0633414341', 'kbog@gmail.com', 3, 6, 3, 1, 1, 1),
(4, 'Ivan', 'Lukić', '9001016713026', '1990-01-01', 'Niš', '0623514351', 'ilukic@gmail.com', 3, 7, 4, 1, 0, 0),
(5, 'Milena', 'Janković', '8808306714027', '1988-08-30', 'Subotica', '0613614361', 'mjankovic@gmail.com', 2, 8, 5, 1, 1, 0),
(6, 'Dragan', 'Pavlović', '8702146715028', '1987-02-14', 'Čačak', '0603714371', 'dpavlovic@gmail.com', 2, 9, 6, 2, 0, 0),
(7, 'Tanja', 'Ilić', '8906226716029', '1989-06-22', 'Beograd', '0693814381', 'tilic@gmail.com', 2, 4, 7, 1, 0, 0),
(8, 'Nemanja', 'Vasić', '8512156717030', '1985-12-15', 'Zaječar', '0683914391', 'nvasic@gmail.com', 2, 5, 8, 1, 1, 0),
(9, 'Sanja', 'Stefanović', '9004036718031', '1990-04-03', 'Beograd', '0674014401', 'sstefanovic@gmail.com', 2, 6, 9, 1, 0, 0),
(10, 'Aleksandra', 'Đurić', '8811186719032', '1988-11-18', 'Valjevo', '0664114411', 'adjuric@gmail.com', 2, 7, 10, 1, 0, 0);
...
ALTER TABLE `seansa`
  ...
  ADD CONSTRAINT `Seansa_Kandidat` FOREIGN KEY (`kandidat_id`) REFERENCES `kandidat` (`kandidat_id`),
